...
void HMI_System_Init(void)
{
    ...
    Get_Input(strptr1);
    UART_sendString(strptr1); /* Sending The First String */
	...
	Get_Input(strptr2);
    UART_sendString(strptr2); /* Sending The Second String */
...
uint8 Get_Password (uint8* ptr)
{
	...
	uint8 pass=0;
	    	        ...
	    	        LCD_ClearScreen();
	    	        LCD_MoveAndDisplayString("Plz Enter Your ", 0 , 0);
	    	        LCD_MoveAndDisplayString("Pass: ", 1, 0);
	    	        LCD_MoveCursor(1, 5);
